...
RUN echo '#!/bin/bash'                                                                                                                               > /root/update.sh; \
    echo ''                                                                                                                                         >> /root/update.sh; \
    echo '# redmine DB data'                                                                                                                        >> /root/update.sh; \
    echo 'if [ ! -f /var/lib/mysql/initialized ]'                                                                                                   >> /root/update.sh; \
    echo 'then'                                                                                                                                     >> /root/update.sh; \
    echo '  cd / && tar xzf /opt/redmine/initdatas/db.tar.gz'                                                                                       >> /root/update.sh; \
    echo '  if [ -n "${REDMINE_HOST}" ]'                                                                                                            >> /root/update.sh; \
    echo '  then'                                                                                                                                   >> /root/update.sh; \
    echo '    /etc/init.d/mysqld start'                                                                                                             >> /root/update.sh; \
    echo '    sleep 10'                                                                                                             >> /root/update.sh; \
    echo "    echo \"insert into settings (name, value, updated_on) value ('host_name', '\${REDMINE_HOST}', current_timestamp)\" > /root/temp.sql"  >> /root/update.sh; \
    echo '    mysql -u redmine -predmine -D redmine < /root/temp.sql'                                                                               >> /root/update.sh; \
    echo '  fi'                                                                                                                                     >> /root/update.sh; \
    echo 'elif [ "`cat /opt/redmine/initialized`" != "`cat /var/lib/mysql/initialized`" ]'                                                          >> /root/update.sh; \
    echo 'then'                                                                                                                                     >> /root/update.sh; \
    echo '  echo "update DB ..."'                                                                                                                   >> /root/update.sh; \
    echo '  cd /opt/redmine'                                                                                                                        >> /root/update.sh; \
    echo '  bundle exec rake db:migrate RAILS_ENV=production'                                                                                       >> /root/update.sh; \
    echo '  bundle exec rake redmine:plugins:migrate RAILS_ENV=production'                                                                          >> /root/update.sh; \
    echo '  bundle exec rake tmp:cache:clear RAILS_ENV=production'                                                                                  >> /root/update.sh; \
    echo '  bundle exec rake tmp:sessions:clear RAILS_ENV=production'                                                                               >> /root/update.sh; \
    echo '  cp -p /opt/redmine/initialized /var/lib/mysql/'                                                                                         >> /root/update.sh; \
    echo '  echo "...done"'                                                                                                                         >> /root/update.sh; \
    echo 'fi'                                                                                                                                       >> /root/update.sh; \
    echo ''                                                                                                                                         >> /root/update.sh; \
    echo '# attachement files'                                                                                                                      >> /root/update.sh; \
    echo 'if [ ! -f /opt/redmine/files/initialized ]'                                                                                               >> /root/update.sh; \
    echo 'then'                                                                                                                                     >> /root/update.sh; \
    echo '  cd / && tar xzf /opt/redmine/initdatas/files.tar.gz'                                                                                    >> /root/update.sh; \
    echo 'fi'                                                                                                                                       >> /root/update.sh; \
    echo ''                                                                                                                                         >> /root/update.sh; \
    echo '# redmine repo'                                                                                                                           >> /root/update.sh; \
    echo 'if [ ! -f /var/opt/redmine/initialized ]'                                                                                                 >> /root/update.sh; \
    echo 'then'                                                                                                                                     >> /root/update.sh; \
    echo '  cd / && tar xzf /opt/redmine/initdatas/repo.tar.gz'                                                                                     >> /root/update.sh; \
    echo '  if [ "${SMTP_ENABLE}" = "y" ]'                                                                                                          >> /root/update.sh; \
    echo '  then'                                                                                                                                   >> /root/update.sh; \
    echo '    echo "default:'                                                                                                                       >> /root/update.sh; \
    echo '    email_delivery:" > ${INSTALL_DIR}/config/configuration.yml'                                                                           >> /root/update.sh; \
    echo ''                                                                                                                                         >> /root/update.sh; \
    echo '    if [ -n "${SMTP_METHOD}" ]'                                                                                                           >> /root/update.sh; \
    echo '    then'                                                                                                                                 >> /root/update.sh; \
    echo '      echo "    delivery_method: :${SMTP_METHOD}" >> ${INSTALL_DIR}/config/configuration.yml'                                             >> /root/update.sh; \
    echo '    fi'                                                                                                                                   >> /root/update.sh; \
    echo ''                                                                                                                                         >> /root/update.sh; \
    echo '      echo "    smtp_settings:" >> ${INSTALL_DIR}/config/configuration.yml'                                                               >> /root/update.sh; \
    echo ''                                                                                                                                         >> /root/update.sh; \
    echo '    if [ -n "${SMTP_STARTTLS}" ]'                                                                                                         >> /root/update.sh; \
    echo '    then'                                                                                                                                 >> /root/update.sh; \
    echo '      echo "      enable_starttls_auto: ${SMTP_STARTTLS}" >> ${INSTALL_DIR}/config/configuration.yml'                                     >> /root/update.sh; \
    echo '    fi'                                                                                                                                   >> /root/update.sh; \
    echo ''                                                                                                                                         >> /root/update.sh; \
    echo '    if [ -n "${SMTP_HOST}" ]'                                                                                                             >> /root/update.sh; \
    echo '    then'                                                                                                                                 >> /root/update.sh; \
    echo '      echo "      address: \"${SMTP_HOST}\"" >> ${INSTALL_DIR}/config/configuration.yml'                                                  >> /root/update.sh; \
    echo '    fi'                                                                                                                                   >> /root/update.sh; \
    echo ''                                                                                                                                         >> /root/update.sh; \
    echo '    if [ -n "${SMTP_PORT}" ]'                                                                                                             >> /root/update.sh; \
    echo '    then'                                                                                                                                 >> /root/update.sh; \
    echo '      echo "      port: ${SMTP_PORT}" >> ${INSTALL_DIR}/config/configuration.yml'                                                         >> /root/update.sh; \
    echo '    fi'                                                                                                                                   >> /root/update.sh; \
    echo ''                                                                                                                                         >> /root/update.sh; \
    echo '    if [ -n "${SMTP_DOMAIN}" ]'                                                                                                           >> /root/update.sh; \
    echo '    then'                                                                                                                                 >> /root/update.sh; \
    echo '      echo "      domain: \"${SMTP_DOMAIN}\"" >> ${INSTALL_DIR}/config/configuration.yml'                                                 >> /root/update.sh; \
    echo '    fi'                                                                                                                                   >> /root/update.sh; \
    echo ''                                                                                                                                         >> /root/update.sh; \
    echo '    if [ -n "${SMTP_AUTHENTICATION}" ]'                                                                                                   >> /root/update.sh; \
    echo '    then'                                                                                                                                 >> /root/update.sh; \
    echo '      echo "      authentication: :${SMTP_AUTHENTICATION}" >> ${INSTALL_DIR}/config/configuration.yml'                                    >> /root/update.sh; \
    echo '    fi'                                                                                                                                   >> /root/update.sh; \
    echo ''                                                                                                                                         >> /root/update.sh; \
    echo '    if [ -n "${SMTP_USER}" ]'                                                                                                             >> /root/update.sh; \
    echo '    then'                                                                                                                                 >> /root/update.sh; \
    echo '      echo "      user_name: \"${SMTP_USER}\"" >> ${INSTALL_DIR}/config/configuration.yml'                                                >> /root/update.sh; \
    echo '    fi'                                                                                                                                   >> /root/update.sh; \
    echo ''                                                                                                                                         >> /root/update.sh; \
    echo '    if [ -n "${SMTP_PASS}" ]'                                                                                                             >> /root/update.sh; \
    echo '    then'                                                                                                                                 >> /root/update.sh; \
    echo '      echo "      password: \"${SMTP_PASS}\"" >> ${INSTALL_DIR}/config/configuration.yml'                                                 >> /root/update.sh; \
    echo '    fi'                                                                                                                                   >> /root/update.sh; \
    echo '  fi'                                                                                                                                     >> /root/update.sh; \
    echo ''                                                                                                                                         >> /root/update.sh; \
    echo 'fi'                                                                                                                                       >> /root/update.sh; \
...
# create initialize shell for user-add
RUN echo 'if [ -n "$ROOT_PASSWORD" ]'                          >> /root/update.sh; \
    echo 'then'                                                >> /root/update.sh; \
    echo '  echo "root:$ROOT_PASSWORD" | chpasswd'             >> /root/update.sh; \
    echo 'fi'                                                  >> /root/update.sh; \
    echo ''                                                    >> /root/update.sh; \
    echo 'if [ -n "$USER" -a -n "$USER_PASSWORD" ]'            >> /root/update.sh; \
    echo 'then'                                                >> /root/update.sh; \
    echo '  useradd $USER'                                     >> /root/update.sh; \
    echo '  echo "$USER:$USER_PASSWORD" | chpasswd'            >> /root/update.sh; \
    echo '  echo "$USER ALL=(ALL) ALL" > /etc/sudoers.d/$USER' >> /root/update.sh; \
    echo '  chmod 440 /etc/sudoers.d/$USER'                    >> /root/update.sh; \
    echo ''                                                    >> /root/update.sh; \
    echo 'fi'                                                  >> /root/update.sh; \
    echo ''                                                    >> /root/update.sh
...
# edit initialize shell for startup
RUN echo '/usr/sbin/httpd -k stop'                                                          >> /root/update.sh; \
    echo '/usr/sbin/httpd -D FOREGROUND'                                                    >> /root/update.sh; \
    echo ''                                                                                 >> /root/update.sh
